package app.kafka.util.serde;

import app.kafka.collectors.FixedSizePriorityQueue;
import app.kafka.model.ClickEvent;
import app.kafka.model.CustomerTransactions;
import app.kafka.model.Purchase;
import app.kafka.model.PurchaseKey;
import app.kafka.model.PurchasePattern;
import app.kafka.model.RewardAccumulator;
import app.kafka.model.ShareVolume;
import app.kafka.model.StockPerformance;
import app.kafka.model.StockTickerData;
import app.kafka.model.StockTransaction;
import app.kafka.model.TransactionSummary;
import app.kafka.util.collection.Tuple;
import app.kafka.util.serializer.JsonDeserializer;
import app.kafka.util.serializer.JsonSerializer;
